...
export function buildDetectorMap(
  ...
  return {
    ...
    detectMissingDocs: () => detectMissingDocs(shitennoDir),
    detectOrphanDirs: () => detectOrphanDirs(shitennoDir),
    detectStaleBuffer: () => detectStaleBuffer(shitennoDir),
    detectDatePlaceholders: () => detectDatePlaceholders(shitennoDir),
    detectEmptyDirs: () => detectEmptyDirs(shitennoDir),
    detectBrokenRefs: () => detectBrokenRefs(shitennoDir),
    detectBrokenDirRefs: () => detectBrokenDirRefs(shitennoDir),
    detectNonBacktickFileRefs: () => detectNonBacktickFileRefs(shitennoDir),
    detectMissingGitignore: () => detectMissingGitignore(shitennoDir),
    detectMaturityInconsistency: () => detectMaturityInconsistency(shitennoDir),
    detectAdrCoverage: () => detectAdrCoverage(shitennoDir),
    detectMissingPackageJson: () => detectMissingPackageJson(shitennoDir),
    detectUnreferencedDirs: () => detectUnreferencedDirs(shitennoDir),
    detectReportNaming: () => detectReportNaming(shitennoDir),
    detectBareWordRefs: () => detectBareWordRefs(shitennoDir),
    detectTemplateDirRefs: () => detectTemplateDirRefs(shitennoDir),
    detectExtensionMismatch: () => detectExtensionMismatch(shitennoDir),
    detectSystemMapMismatch: () => detectSystemMapMismatch(shitennoDir),
    detectBrokenCommands: () => detectBrokenCommands(shitennoDir),
    detectP0Inconsistency: () => detectP0Inconsistency(shitennoDir),
    detectTripleMaturityScore: () => detectTripleMaturityScore(shitennoDir),
    detectEmptyStack: () => detectEmptyStack(shitennoDir),
    detectScriptWiring: () => detectScriptWiring(projectRoot, shitennoDir),
    detectAgentContractRefs: () => detectAgentContractRefs(shitennoDir),
    detectBufferSchemaMismatch: () => detectBufferSchemaMismatch(shitennoDir),
    detectRuleTypo: () => detectRuleTypo(shitennoDir),
    detectNumberingGap: () => detectNumberingGap(shitennoDir),
    detectDocCountMismatch: () => detectDocCountMismatch(shitennoDir),
    detectCrossDocP0Contradiction: () => detectCrossDocP0Contradiction(shitennoDir),
    detectEmptyDataFiles: () => detectEmptyDataFiles(shitennoDir),
    detectPhantomRuleRefs: () => detectPhantomRuleRefs(shitennoDir),
    detectOrphanSkills: () => detectOrphanSkills(shitennoDir),
    ...
    detectIncompleteSessionClose: () => detectIncompleteSessionClose(shitennoDir),
    detectMissingFeedback: () => detectMissingFeedback(shitennoDir),
    detectInvalidBacklogStates: () => detectInvalidBacklogStates(shitennoDir),
    detectPlanFormat: () => detectPlanFormat(shitennoDir),
    detectRuleExecutionCompliance: () => detectRuleExecutionCompliance(shitennoDir),
