# Skill: Operação no Nexus System

Esta skill é portável — copiável para qualquer projeto que use o Nexus, sem adaptação. Ela descreve **como agir dentro desta estrutura de pastas**, não decisões específicas de nenhum projeto.
...
4. Se a tarefa tocou em regra de governança de um projeto hospedeiro
   (não do próprio Nexus), houve aprovação explícita do Tech Lead
   antes de aplicar?
