...
| 📋 | Capacidade disponível (pode ser instalada via `shiten upgrade`) |
| 🔮 | Capacidade futura (não disponível ainda) |
| ➖ | Não aplicável |

**Verificar capacidades instaladas:** `shiten status` ou `shiten doctor`
**Instalar capacidade:** `shiten upgrade --capability <name>`
...
│   docs/skills/operacao_no_shiten.md
...
│   governance/plans/done/brand-change/plano-rebranding-shitenno-go.md
│   governance/plans/done/brand-change/rename-shitenno-go.py
...
| Ficheiro | Descrição |
|---|---|
| `docs/CONCEPTUAL_MODEL.md` | Modelo conceitual canónico do Shiten |
