...
import { SYSTEM_MAP, SHITEN, type ValidatorContext, type FixAction, pass, warn, error, dryLog } from "./shared.js";
...
export function checkSystemMap(ctx: ValidatorContext) {
  ...
  ctx.fixActions.push({
    file: "shitenno-go/governance/SYSTEM_MAP.md",
  ...
  if (ctx.DRY_RUN) {
    ...
    error(ctx, "SYSTEM_MAP.md directory tree is outdated", "shitenno-go/governance/SYSTEM_MAP.md", true);
  }
}
