# Plano Master: Expansão Completa do Shiten Audit

**Data:** 2026-07-04  
**Atualizado:** 2026-07-04  
**Status:** 🔄 EM PROGRESSO  
**Objetivo:** Transformar o shiten audit num sistema de auditoria completo, reutilizável, com ~160+ detectores e nível "code review" end-to-end.
...
- **Foco**: projeto Shiten (não reutilizável para outros projetos)
...
- Cache inválido por `shiten audit --no-cache`
...
```
shiten audit --level code-review
```
...
### Princípio
O shitenno-go deve servir para **outros projetos**. Os detectores devem ser adaptativos.
...
5. **Force**: `shiten audit --no-cache` ignora cache
