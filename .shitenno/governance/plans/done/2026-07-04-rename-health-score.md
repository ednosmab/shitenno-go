...
|---|---|---|---|---|
| Session | `shiten console` | `Health Score` | successRate×40 + cacheHitRate×30 + sessions×30 | `src/commands/console.ts:103` |
| Code | `shiten audit` | `Health Score` | 100 − Σ(severity penalties) | `src/health-auditor.ts:927` |
| Risk | `shiten doctor` | `health score` | 100 − Σ(risk-severity penalties) | `src/commands/doctor.ts:243` |
