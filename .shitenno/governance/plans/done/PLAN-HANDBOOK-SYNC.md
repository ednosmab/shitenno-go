...
- [ ] Passo 5 — Integração `shiten handbook fill`
- [ ] Passo 6 — Testes
- [ ] Passo 1 — Skill handbook-fill
- [ ] Passo 2 — RULE-HB-001
- [ ] Passo 3 — Template base
- [ ] Passo 4 — Quick Board
- [ ] Passo 5 — shiten handbook fill
- [ ] Passo 6 — Testes

## 1. Contexto

O handbook é a documentação de utilizador do Shiten. Tem duas camadas de conteúdo:
...
|---|-----------|------|-----------|
| 1 | **Skill `handbook-fill`** | `shitenno-go/docs/skills/handbook-fill.md` | Protocolo para AI preencher dados semânticos |
| 2 | **RULE-HB-001** | `shitenno-go/governance/rules/RULE-HB-001.json` | Regra que dispara no session_start |
| 3 | **Template base** | `docs/handbook/handbook.template.md` | Template com marcadores SEMANTIC/PHILOSOPHY |
| 4 | **Quick Board update** | `shitenno-go/docs/skills/quick-board-enforcement.md` | Adicionar secção handbook |
| 5 | **`shiten handbook fill`** | `src/commands/handbook.ts` | Extensão do command para escrever handbook |
...
**Ficheiro:** `shitenno-go/docs/skills/handbook-fill.md`
...
**Ficheiro:** `shitenno-go/governance/rules/RULE-HB-001.json`
...
| shiten handbook fill funciona | Escreve handbook final |
...
|---|------|--------|-----------|
| 1.1 | Criar `shitenno-go/docs/skills/handbook-fill.md` | ⬜ | |
...
| # | Step | Estado | Evidência |
|---|------|--------|-----------|
| 2.1 | Criar `shitenno-go/governance/rules/RULE-HB-001.json` | ⬜ | |
...
| 6.4 | Teste: shiten handbook fill --dry-run | ⬜ | |
...
| Reminder | Via `shiten reminders` | Já existe infra |
