# Gap Analysis & Coverage Plan — Shiten CLI
...
| 4 | A4 | Git hooks (`shiten hooks --install`) | Backlog | Baixo (1-2 dias) |
| 5 | A7 | Skill template (`shiten skill:create`) | Backlog | Baixo (1-2 dias) |
| 6 | A5 | Webhook de sessão | Backlog | Baixo (1 dia) |
| 7 | A6 | Context injection API (`shiten serve`) | Backlog | Médio (2-3 dias) |
...
| 3.3 | Implementar shiten hooks --install | src/commands/hooks.ts | 2 dias | automation +10 |
| 3.4 | Implementar shiten detect --approve/--reject | src/commands/detect.ts | 1 dia | automation +5 |
| 3.5 | Shiten bench --compare | src/commands/bench.ts | 1 dia | Observabilidade |
| 3.6 | Shiten feedback --list | src/commands/feedback.ts | 2h | DX |
...
| 5.3 | Shiten feedback --list (2.4) | feedback.ts | 2h | DX |
| 5.4 | Shiten bench --compare (2.3b) | bench.ts | 1 dia | DX |
