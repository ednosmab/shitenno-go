Plano Estratégico - Próximo Estágio do Nexus System

Objetivo

Consolidar o Nexus System como uma plataforma de Gestão da Evolução de Produtos, tornando-o capaz de acompanhar, compreender e orientar a evolução do conhecimento, da governança e da arquitetura de um projeto durante todo o seu ciclo de vida.

Este plano não adiciona apenas funcionalidades.

Ele fortalece o modelo conceitual do Nexus.
...
Definir explicitamente os conceitos fundamentais do Nexus.
...
O Nexus passa a ser instalado por capacidades.
...
Transformar o Nexus em um sistema que acompanha continuamente a evolução do projeto.
...
O Nexus deixa de ser um instalador.
...
Centralizar todos os comportamentos automáticos do Nexus.
...
Representar explicitamente as relações entre os artefatos do Nexus.
...
O Nexus passa a atuar como mentor durante o desenvolvimento.
...
Permitir que o Nexus recomende sua própria evolução.
...
Consolidar os fundamentos do Nexus.
...
Transformar o Nexus em um sistema que aprende junto com o projeto.

---

Critérios de sucesso

O próximo estágio do Nexus será considerado bem-sucedido quando:
...
- o Nexus recomendar sua própria evolução de forma fundamentada;
...
O Nexus deverá evoluir para uma plataforma onde documentação, governança, arquitetura, automação e inteligência artificial deixam de ser componentes isolados.

Eles passam a representar diferentes manifestações do mesmo ativo:

Conhecimento aplicado à evolução contínua de produtos.

Nesse modelo, o Nexus não apenas organiza o trabalho de engenharia.
