...
O sistema Nexus mostra **sempre dois caminhos** ao utilizador:
...
**Funções Principais:**
- `loadGrowthProfile(nexusDir: string): GrowthProfile`
- `saveGrowthProfile(nexusDir: string, profile: GrowthProfile): void`
- `recordPathChoice(nexusDir: string, choice: PathChoice): GrowthProfile`
...
- `calculateKnowledgeGap(recommendation: Recommendation, state: NexusState): KnowledgeGap`
