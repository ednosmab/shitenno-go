...
### Step 3: Actualizar Nexus-System_GUIDE.md (médio)

| # | Accão | Verificação |
|---|---|---|
| 3.1 | Corrigir "6 relatórios" → contagem real de `complexity-*.json` | `ls nexus-system/reports/complexity-*.json \| wc -l` |
| 3.2 | Corrigir "15 registos de feedback" → 14 | `ls nexus-system/feedback/records/ \| wc -l` |
| 3.3 | Adicionar `docs/audits/` e `docs/capabilities.md` à árvore de ficheiros | `grep "audits" Nexus-System_GUIDE.md` |
...
| 7.3 | `nexus audit --level full --json \| jq .issues \| wc -l` | ≤ 66 issues |
...
| `nexus-system/docs/Nexus-System_GUIDE.md` | Contagens, árvore |
| `nexus-system/docs/CONCEPTUAL_MODEL.md` | Paths, data |
| `nexus-system/governance/SYSTEM_MAP.md` | Árvore |
