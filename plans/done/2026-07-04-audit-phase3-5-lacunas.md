# Plan: Nexus Audit Phase 3 — 5 Remaining Gaps
...
- **Exception:** Skip barrel files (`index.ts`), entry points (`bin/nexus.ts`), re-exports
...
4. `npx nexus audit --level full --no-cache` — verify new issue types appear
