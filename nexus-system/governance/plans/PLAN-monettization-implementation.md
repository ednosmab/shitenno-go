# Plano de Implementação — Monetização Nexus CLI

**Status:** Planeado
**Updated_at:** 2026-07-14T04:51:44.937Z
**Date:** 2026-07-14
**Data:** 2026-07-13
**Referência:** `PLANO-MONETIZACAO-NEXUS.md`

---

## Visão Geral

Adicionar um sistema de licenciamento ao Nexus CLI que suporte dois tiers: **Free** (motor de tração) e **Pro** (features avançadas). O sistema usa JWT assinado com Ed25519, validado localmente pelo CLI, sem necessidade de conexão à rede para verificar a licença.
...
└─────────────────────────────────────────────────────────┘
                          ...
                          ▼
┌─────────────────────────────────────────────────────────┐
│              Cloudflare Worker (nexus-license)          │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │
...
- Implementar `getLicense()` — lê e valida JWT de `~/.nexus/license.token`
...
- Formato: `nexus license activate <licenseKey>`

**Ficheiro modificar: `bin/nexus.ts`**
...
3. `src/commands/license.ts` + `bin/nexus.ts` (comando)
...
- **Domínio do Worker**: `nexus-license.SEU-SUBDOMINIO.workers.dev`
