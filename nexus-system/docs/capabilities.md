...
| Comando | Função |
|---|---|
| `nexus init` | Instala capacidades seleccionadas |
| `nexus upgrade --capability <name>` | Adiciona uma capacidade |
| `nexus assess` | Mostra capacidades recomendadas |
| `nexus doctor` | Verifica estado das capacidades |
| `nexus status` | Mostra estado geral do sistema |
