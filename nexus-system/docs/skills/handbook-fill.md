...
<!-- PHILOSOPHY -->
## Visão
O Nexus é um framework de governança...
...
## 🔗 Referências
- `nexus-system/governance/rules/RULE-HB-001.json` — Regra de activação
- `docs/handbook/*.template.md` — Templates a preencher
- `src/commands/handbook.ts` — Command CLI
- `nexus-system/docs/skills/quick-board-enforcement.md` — Quick Board
